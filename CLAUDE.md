...
| `claude/skills/`       | Global skills: `/commit`, `/spec`, `/audit-spec`, `/audit-spec-leaks`, `/redact-spec-leaks`, `/load-spec`, `/update-spec`, `/implement-spec`, `/create-issue`, `/create-mr`, `/review-mr`, `/re-review-mr`, `/evaluate-mr-notes`, `/cleanup-review-worktrees` |
